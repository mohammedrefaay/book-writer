document.addEventListener("DOMContentLoaded", function() {
    ...
    addBtn.addEventListener("click", function() {
      ...
      <div class="container h-100" id="chapter-editor-${chapterID}">
        <div class="title">
          <h1 id="chapterTitle" contenteditable="true" onclick="getChapterTitle(this)">Add Chapter title</h1>
          <hr class="solid">
        </div>
...
function getChapterTitle(clickedChapter) {
    ...
    clickedChapter.addEventListener("keyup", (event) => {
        if (event.keyCode === 13 || event.code === "Enter") {
            ...
            requiredPreviewTitle.innerHTML = clickedChapter.innerText;
        }
    })
}
